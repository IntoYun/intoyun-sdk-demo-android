...
package com.molmc.intoyundemo.support.zxing.camera;
...
public final class CameraManager {
    ...
    private CameraManager(Context context) {
        MIN_FRAME_WIDTH = Utils.dip2px(MIN_FRAME_WIDTH);
        MIN_FRAME_HEIGHT = Utils.dip2px( MIN_FRAME_HEIGHT);
        MAX_FRAME_WIDTH = Utils.dip2px(MAX_FRAME_WIDTH);
        MAX_FRAME_HEIGHT = Utils.dip2px(MAX_FRAME_HEIGHT);
