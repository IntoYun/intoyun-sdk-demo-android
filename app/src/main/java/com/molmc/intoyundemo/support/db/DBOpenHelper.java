...
public class DBOpenHelper extends SQLiteOpenHelper {
     ...
     * @author lihy
     */
    public static DBOpenHelper getInstance(Context context, String dbName, int dbVersion) {
        DBOpenHelper dataBaseOpenHelper = dbMaps.get(dbName);
        if (dataBaseOpenHelper == null) {
            dataBaseOpenHelper = new DBOpenHelper(context, dbName, dbVersion);
        }
     ...
     * @author lihy
     */
    public void replace(String table, ContentValues contentValues) {
        DBOpenHelper dataBaseOpenHelper = dbMaps.get(nowDbName);
        synchronized (dataBaseOpenHelper) {
            SQLiteDatabase database = dataBaseOpenHelper.getWritableDatabase();
