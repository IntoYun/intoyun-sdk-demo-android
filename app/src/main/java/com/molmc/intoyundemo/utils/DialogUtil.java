...
public class DialogUtil {
     ...
     */
    public static void showMenuDialog(Context context, String[] menuArr, final DialogInterface.OnClickListener onItemClickListener) {
        new MaterialDialog.Builder(context)
                .items(menuArr)
                .itemsCallback((dialog, view, which, text) -> onItemClickListener.onClick(dialog, which))
                .show();
    }
